...
// CATÁLOGO GENERAL DE HABILITACIÓN ADMINISTRATIVA POR AÑO
...
export const DocentesAcompañantesManagement = () => {
  ...
  const handleAssignStudent = async () => {
    ...
    try {
      await teacherService.assignStudent(selectedDocente.id, selectedEstudianteObject.id);
  ...
  // FILTRAR SOLO LOS FORMULARIOS ACTIVOS DEL DOCENTE
  ...
  // Filtrado dinámico para asignación
  ...
  return (
    <div className="space-y-6 font-sans">
        ...
        <div className="relative z-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-300 max-w-xl leading-relaxed">
              Administración de docentes tutores de la ESFM/UA, gestión de asignaciones y visualización de formularios habilitados.
            </p>
          </div>
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            title="Ver / Asignar Estudiantes / Formularios del Docente"
      ...
      {/* MODAL GESTIÓN DEL DOCENTE (ASIGNACIONES + CONTROL + VER FORMULARIOS HABILITADOS) */}
      {showModal && selectedDocente && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 overflow-y-auto">
          <div className="relative w-full max-w-4xl rounded-3xl bg-white p-6 sm:p-8 shadow-2xl border border-slate-100 max-h-[90vh] overflow-y-auto">
            ...
            {/* ENCABEZADO Y BOTÓN DE ADMINISTRACIÓN DE FORMULARIOS */}
            <div className="border-b border-slate-200 pb-4 mb-6 flex flex-wrap items-center justify-between gap-4">
              ...
              >
                <FileText size={16} />
                {showFormulariosPanel ? 'Ocultar Panel Habilitación' : 'Habilitar Formularios'}
              </button>
            </div>

            {/* SECCIÓN 1: FORMULARIOS HABILITADOS ACTUALMENTE PARA ESTE DOCENTE */}
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 mb-6 space-y-3">
              ...
              {formulariosActivosDocente.length > 0 ? (
                ...
                <div className="p-4 text-center text-slate-400 font-medium text-xs border border-dashed border-slate-200 rounded-xl">
                  Este docente no tiene formularios activos asignados actualmente.
                </div>
              )}
            </div>

            {/* SECCIÓN 2: PANEL DE CONTROL DE HABILITACIÓN ADMINISTRATIVA */}
            {showFormulariosPanel && (
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 border-b border-amber-200/80 pb-3">
                  <div>
                    <h3 className="font-black text-slate-900 text-sm flex items-center gap-2">
                      ...
                      HABILITAR O DESHABILITAR FORMULARIOS PARA EL DOCENTE
                    </h3>
                    <p className="text-[11px] text-slate-500 mt-0.5">
                      ACTIVE EL SWITCH PARA PERMITIR AL DOCENTE VER Y LLENAR CADA FORMULARIO
                    </p>
                  </div>
            ...
            {/* SECCIÓN 3: BUSCADOR EN TIEMPO REAL PARA ASIGNACIÓN DE ESTUDIANTES */}
            ...
            {/* SECCIÓN 4: TABLA DE ESTUDIANTES ASIGNADOS */}

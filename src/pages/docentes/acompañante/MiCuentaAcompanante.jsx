  ...
  useEffect(() => {
    ...
    if (savedUser) {
      try {
        ...
        console.error("Error al cargar perfil del docente", e);
      }
    }
  }, []);
        ...
        <div className="relative z-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-300 max-w-xl leading-relaxed">
              Configuración del perfil del Docente Acompañante, actualización de credenciales de acceso y contacto institucional.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="space-y-1 text-center md:text-left flex-1">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-1 text-[11px] font-semibold text-slate-500">
            ...
            <span>•</span>
            <span>Especialidad: {profile.especialidad}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
          <div className="border-b border-slate-100 pb-4">
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Actualiza tu dirección de correo y número de contacto institucional.
            </p>
          </div>

          <form onSubmit={handleSaveContact} className="space-y-4 text-xs">
            <div>
              <label className="block font-extrabold text-slate-700 mb-1">Correo Electrónico Institucional *</label>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
          <div className="border-b border-slate-100 pb-4">
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              Asegura tu cuenta actualizando periódicamente tu clave de acceso.
            </p>
          </div>
